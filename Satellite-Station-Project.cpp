...
void sat1()
{
    ...
    glColor3f(1, 1, 1);
    drawstring(1, 3.7, -1.0, const_cast <char*>("SATELITE"));
    setFont(GLUT_BITMAP_TIMES_ROMAN_24);
    glColor3f(1, 1, 1);
    drawstring(-4.4, .5, -1.0, const_cast <char*>("RECEIVER"));
    setFont(GLUT_BITMAP_TIMES_ROMAN_24);
    glColor3f(1, 1, 0);
    drawstring(0, -2, 7, const_cast <char*>("RECEIVER"));
    setFont(GLUT_BITMAP_TIMES_ROMAN_24);
    glColor3f(1, 1, 1);
    drawstring(-1.5, -1, -1.0, const_cast <char*>("TRANSMITTER"));
    setFont(GLUT_BITMAP_TIMES_ROMAN_24);
    glColor3f(1, 1, 1);
    drawstring(3.2, 1, 3, const_cast<char*>("RECEIVER"));
    glPopMatrix();
